...
export default function Card({ val, navcolor, setColor , id}) {
  ...
  return (
    <div onClick={clickHandler} style={{ opacity: 1 }} className='check_bottle h-full  shadow-xl hover:shadow-2xl cursor-pointer duration-75 translate-1 rounded-2xl  flex flex-col justify-center items-center font-["Comic Sans MS", "Comic Sans", cursive] py-6'>
